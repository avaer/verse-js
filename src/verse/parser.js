...
function peg$parse(input, options) {
 ...
 return ClassDefinition(name, parentClass, members);
  ...
  var peg$f9 = function(name, parentClass, members) {
 return ClassDefinition(name, parentClass, members);
 };
  var peg$f10 = function(name, arrayIndex, operator, value) {
 ...
 return IfStatement(condition, body, tail || []);
  ...
  var peg$f13 = function(condition, body, tail) {
 return IfStatement(condition, body, tail || []);
 };
  var peg$f14 = function(condition, body, elseBody) {
 return IfStatement(condition, body, elseBody);
 };
  var peg$f15 = function(condition, body) {
 return IfStatement(condition, body, []);
 };
  var peg$f16 = function(condition, body, tail) {
 return [IfStatement(condition, body, tail || [])];
 };
  var peg$f17 = function(elseBody) {
 return elseBody;
 };
  var peg$f18 = function(variable, value) {
 ...
 return LoopStatement(body);
  ...
  var peg$f21 = function(variable, start, end, body) {
 return ForStatement(variable, null, start, end, body);
 };
  var peg$f22 = function(variable, varType, start, end, body) {
 return ForStatement(variable, varType, start, end, body);
 };
  var peg$f23 = function(variable, start, end, body) {
 return ForStatement(variable, null, start, end, body);
 };
  var peg$f24 = function(variable, varType, start, end, body) {
 return ForStatement(variable, varType, start, end, body);
 };
  var peg$f25 = function(start, end) {
 return Range(start, end);
 };
  var peg$f26 = function() { return BreakStatement(); };
  var peg$f27 = function(parts) { return InterpolatedString(parts); };
  var peg$f28 = function(text) { return TextPart(text); };
 ...
 return BinaryExpression(left, operator, right);
  ...
  var peg$f34 = function(operator, expression) {
 ...
 return text();
  ...
  var peg$f39 = function(value) { return StringLiteral(value); };
  var peg$f40 = function(value) { return IntegerLiteral(value); };
  var peg$f41 = function(value) { return FloatLiteral(value); };
  var peg$f42 = function() { return BooleanLiteral(true); };
  var peg$f43 = function() { return BooleanLiteral(false); };
  var peg$f44 = function(elements) {
 return ArrayLiteral(elements !== null ? elements : []);
 };
  var peg$f45 = function(head, tail) {
 return [head, ...tail.map(item => item[3])];
 };
  var peg$f46 = function(elementType) {
 return { type: "ArrayType", elementType };
 };
  var peg$f47 = function(array, index) {
 ...
 [...preEffects, ...postEffects]
  ...
  var peg$f50 = function(name, preEffects, parameters, postEffects, returnType, body) {
 return FunctionDeclaration(
 name,
 parameters || [],
 returnType,
 ...
 [...preEffects, ...postEffects]
  ...
  var peg$f51 = function(body) {
 return BraceBlock(body);
 };
  var peg$f52 = function(name) { return name.name; };
  var peg$f53 = function(head, tail) {
 return [head, ...tail.map(item => item[3])];
 };
  var peg$f54 = function(name, paramType) {
 return Parameter(name, paramType);
 };
  var peg$f55 = function(returnType) {
 return returnType;
 };
  var peg$f56 = function(name, args) {
 return FunctionCall(name, args || [], false);
 };
  var peg$f57 = function(name, args) {
 ...
 return ReturnStatement(value);
  ...
  var peg$f60 = function(functionCall) {
 return FunctionCallStatement(functionCall);
 };
  var peg$f61 = function(expression) {
              ...
              if (s16 !== peg$FAILED) {
                ...
                if (s18 !== peg$FAILED) {
                  ...
                  if (s19 !== peg$FAILED) {
                    s20 = peg$parse_();
                    peg$savedPos = s0;
                    s0 = peg$f49(s1, s2, s6, s10, s14, s18);
                  } else {
                    peg$currPos = s0;
                    s0 = peg$FAILED;
                  }
            ...
            if (s12 !== peg$FAILED) {
              ...
              if (s14 !== peg$FAILED) {
                ...
                if (s16 !== peg$FAILED) {
                  ...
                  if (s17 !== peg$FAILED) {
                    peg$savedPos = s0;
                    s0 = peg$f50(s1, s2, s6, s10, s14, s17);
                  } else {
                    peg$currPos = s0;
                    s0 = peg$FAILED;
                  }
